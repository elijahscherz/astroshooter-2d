...
public class ShipData {
    ...
    // Default ship values.
    public const float SHIP_DEFAULT_SPEED = 25.0f;
    public const float SHIP_DEFAULT_TURNSPEED = 3.0f;
    public const float SHIP_DEFAULT_FIRERATE = 0.2f;
    ...
    public const bool SHIP_DEFAULT_CANCONTROLWARP = false;
    ...
    // A speedy ship type.
    public const float SHIP_SPEEDY_SPEED = 51.0f;
    ...
    public const bool SHIP_SPEEDY_CANREVERSE = false;
    public const bool SHIP_SPEEDY_CANCONTROLWARP = false;

    public const float SHIP_SPEEDY_LINEARDRAG = 0.35f;
